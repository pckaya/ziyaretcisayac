...
return [
    ...
    'modules' => [
        'site' => [
            'class' => 'kouosl\site\ziyaretcisayac'   // here is our v1 modules
        ], 
        'menu' => [
            'class' => 'kouosl\menu\ziyaretcisayac',
            ],
        'user' => [
            'class' => 'kouosl\user\ziyaretcisayac'   // here is our v1 modules
        ],
        'sample' => [
            'class' => 'kouosl\sample\ziyaretcisayac'   // here is our v1 modules
        ]
